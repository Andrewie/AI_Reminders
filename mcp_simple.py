...
def main():
    ...
    if len(sys.argv) > 1:
        if sys.argv[1] == "--test":
            ...
            print("  python mcp_simple.py [reminders_file]", file=sys.stderr)
            print("  python mcp_simple.py --test", file=sys.stderr)
            print("  python mcp_simple.py --help", file=sys.stderr)
            return
        else:
